<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="col-12 col-md-6 mx-auto mt-5">
        ...
        <div class="input-group mb-3">
            ...
            <x-forms.text-input type="text" name="name" placeholder="Nickname" :value="old('name')" required autofocus/>
        ...
        <div class="input-group mb-3">
            ...
            <x-forms.text-input placeholder="Password" type="password" name="password_confirmation" required />
